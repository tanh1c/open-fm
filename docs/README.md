...
This directory contains the technical documentation for Open Futball Manager, a web-first football management simulation built with React (TypeScript) and a Rust/WASM simulation engine.
